...
P0PORT=11051
CAPORT=11054
PEERPEM=$pwd../network/organizations/peerOrganizations/org3.example.com/tlsca/tlsca.org3.example.com-cert.pem
CAPEM=$pwd../network/organizations/peerOrganizations/org3.example.com/ca/ca.org3.example.com-cert.pem

echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM)" > $pwd../network/organizations/peerOrganizations/org3.example.com/connection-org3.json
